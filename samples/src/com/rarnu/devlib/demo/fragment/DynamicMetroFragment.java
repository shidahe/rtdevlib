...
public class DynamicMetroFragment extends BaseFragment implements FocusCallback {
	...
	public void initComponents() {
		...
		// the main activity is not landscape, so here needs to swap the width and height value;
	...
	public void initLogic() {
		...
		mvPage1.setViews(mp1.getViews(getActivity(),
				...
				new int[] { R.id.ivImage, R.id.tvItem }, options, this));
